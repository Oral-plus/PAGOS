...
const FPDF_FONT_DIR = __DIR__.'/font/';
	...
	foreach($this->fonts as $k=>$font)
	{
		...
		elseif($type=='Type1' || $type=='TrueType')
		{
			...
			if(isset($font['diffenc']))
			{
				// Differences
				$this->_newobj();
				$this->_out('<</Type /Encoding /BaseEncoding /WinAnsiEncoding /Differences ['.$font['diffenc'].']>>');
				$this->_out('endobj');
			}
		}
		else
...
// Core fonts
require_once(__DIR__.'/fpdf_fonts.php');
?>
